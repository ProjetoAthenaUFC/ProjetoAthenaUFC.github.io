...
textoRecursosI.push(matI10);
    var matI11 = {texto: "D11 - Resolver problema envolvendo o cálculo do perímetro de figuras planas, desenhadas em malhas quadriculadas.", descritor:"DMI11"};
textoRecursosI.push(matI11);
    var matI12 = {texto: "D12 - Resolver problema envolvendo o cálculo ou estimativa de áreas de figuras planas, desenhadas em malhas quadriculadas.", descritor:"DMI12"};
textoRecursosI.push(matI12);
    var matI13 = {texto: "D13 - Reconhecer e utilizar características do sistema de numeração decimal, tais como agrupamentos e trocas na base 10 e princípio do valor posicional.", descritor:"DMI13"};
...
textoRecursosI.push(matI14);
    var matI15 = {texto: "D15 - Reconhecer a decomposição de números naturais nas suas diversas ordens.", descritor:"DMI15"};
...
textoRecursosI.push(matI21);
    var matI22 = {texto: "D22 - Identificar a localização de números racionais representados na forma decimal na reta numérica.", descritor:"DMI22"};
...
textoRecursosII.push(matII30);
    var matII31 = {texto: "D31 - Resolver problema que envolva equação do 2º grau.", descritor:"DMII31"};
...
textoRecursosII.push(matII32);
    var matII33 = {texto: "D33 - Identificar uma equação ou inequação do 1º grau que expressa um problema.", descritor:"DMII33"};
textoRecursosII.push(matII33);
    var matII34 = {texto: "D34 - Identificar um sistema de equações do 1º grau que expressa um problema.", descritor:"DMII34"};
textoRecursosII.push(matII34);
    var matII35 = {texto: "D35 - Identificar a relação entre as representações algébrica e geométrica de um sistema de equações do 1º grau.", descritor:"DMII35"};
...
function processData(textoParam){
	...
	for (var i=0; i < linhas.length; i++){
        ...
        if(tituloDescritoresI == 'Descritores do 4º/5º ano'){
            ...
            document.getElementById("descritoresRecurso").innerHTML = '<b>'+ tituloDescritoresII + '</b>' + descritoresII + nenhumRecursoS;
        }
